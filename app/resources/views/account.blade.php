                        ...
                        <table class="dat-table stg-sites-table" id="stg-sites-table" style="min-width:0">
                            <thead>
                                <tr>
                                    ...
                                    {{-- GH-541: the site's own soil-test methodology. This screen is the owner's checking place — "where I look to see what is set where" — so the value is the one on THIS row's site. --}}
                                    <th class="stg-st-sortable" data-col="methodology">Methodology <svg class="stg-sort-icon" width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M12 5v14M5 12l7-7 7 7"/></svg></th>
