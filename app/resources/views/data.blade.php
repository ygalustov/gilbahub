...
(function () {
    ...
    var SOIL_FULL = [
        ...
        { keys:['S','s','sulfur','Sulfur'],            name:'Sulphur (S)',          unit:'ppm' },
    ...
    var TISSUE_KEY = [
        ...
        { keys:['S','s','sulfur'],    name:'Sulphur (S)',      unit:'%',  opt:[0.2,0.5], max:1 },
    ];
    var WATER_KEY = [
    ...
    var CMP_FIELDS = {
        soil: [
            ...
            { keys:['S','s','sulfur','Sulfur','sulphur'],                      label:'Sulphur (S)',      unit:'ppm' },
        ...
        tissue: [
            ...
            { keys:['S','s','sulfur','Sulfur'],                  label:'Sulphur (S)',      unit:'%' },
        ...
        water: [
            ...
            { keys:['TDS','tds'],                                                  label:'TDS',             unit:'ppm' },
            { keys:['Ca','ca','calcium','Calcium'],                                label:'Calcium (Ca)',    unit:'ppm' },
            { keys:['Mg','mg','magnesium','Magnesium'],                            label:'Magnesium (Mg)', unit:'ppm' },
            { keys:['Na','na','sodium','Sodium'],                                  label:'Sodium (Na)',     unit:'ppm' },
            { keys:['K','k','potassium','Potassium'],                              label:'Potassium (K)',   unit:'ppm' },
            ...
            { keys:['NO3','no3','nitrate','Nitrate'],                              label:'Nitrate (NO3)',   unit:'ppm' },
            { keys:['P','p','phosphate','Phosphate','PO4','phosphorus'],           label:'Phosphate (P)',   unit:'ppm' },
            { keys:['B','b','boron','Boron'],                                      label:'Boron (B)',       unit:'ppm' },
            { keys:['Fe','fe','iron','Iron'],                                      label:'Iron (Fe)',       unit:'ppm' },
            { keys:['Mn','mn','manganese','Manganese'],                            label:'Manganese (Mn)', unit:'ppm' },
...
(function () {
    ...
    var CSV_MAPS = {
        ...
        water: {
            ...
            'CO3': 'CO3', 'co3': 'CO3', 'carbonate': 'CO3', 'Carbonate': 'CO3',
            'NO3': 'NO3', 'no3': 'NO3', 'nitrate': 'NO3', 'Nitrate': 'NO3',
            'P': 'P', 'p': 'P', 'phosphate': 'P', 'Phosphate': 'P', 'PO4': 'P', 'phosphorus': 'P',
            'B': 'B', 'b': 'B', 'boron': 'B', 'Boron': 'B',
            'Fe': 'Fe', 'fe': 'Fe', 'iron': 'Fe', 'Iron': 'Fe',
            'Mn': 'Mn', 'mn': 'Mn', 'manganese': 'Mn', 'Manganese': 'Mn',
            'SAR': 'SAR', 'sar': 'SAR',
            'Sample_ID': '__uid', 'SampleID': '__uid', 'Sample ID': '__uid', 'Sample': '__uid',
            'Date': '__date', 'date': '__date',
            'Lab': '__lab', 'Lab_Name': '__lab',
            'Notes': '__notes', 'notes': '__notes',
        },
        loi: {
    ...
    var MANUAL_FORMS = {
        ...
        water: {
            ...
            nutrients: [
                ...
                { id: 'EC',   label: 'EC',          unit: 'dS/m', placeholder: '' },
                { id: 'TDS',  label: 'TDS',         unit: 'ppm',  placeholder: '' },
                { id: 'Ca',   label: 'Ca',          unit: 'ppm',  placeholder: '' },
                { id: 'Mg',   label: 'Mg',          unit: 'ppm',  placeholder: '' },
                { id: 'Na',   label: 'Na',          unit: 'ppm',  placeholder: '' },
                { id: 'K',    label: 'K',           unit: 'ppm',  placeholder: '' },
                ...
                { id: 'CO3',  label: 'CO3',         unit: 'ppm',  placeholder: '' },
                { id: 'NO3',  label: 'NO3',         unit: 'ppm',  placeholder: '' },
                { id: 'P',    label: 'P',           unit: 'ppm',  placeholder: '' },
                { id: 'B',    label: 'B',           unit: 'ppm',  placeholder: '' },
                { id: 'Fe',   label: 'Fe',          unit: 'ppm',  placeholder: '' },
                { id: 'Mn',   label: 'Mn',          unit: 'ppm',  placeholder: '' },
