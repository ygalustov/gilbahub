<nav class="db-sidebar">
    ...
    <a href="{{ route('dashboard') }}" class="db-nav-item{{ ($currentPage ?? '') === 'dashboard' ? ' active' : '' }}" title="Dashboard">
    ...
    <a href="{{ route('data') }}" class="db-nav-item{{ ($currentPage ?? '') === 'data' ? ' active' : '' }}" title="Data">
        <svg width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
    ...
    <a href="{{ route('analysis') }}" class="db-nav-item{{ ($currentPage ?? '') === 'analysis' ? ' active' : '' }}" title="Analysis">
        <svg width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
    ...
    <a href="{{ route('plan') }}" class="db-nav-item{{ ($currentPage ?? '') === 'plan' ? ' active' : '' }}" title="Plan">
        <svg width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
