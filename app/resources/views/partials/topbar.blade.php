    ...
    <div class="db-site-switcher-wrap" id="db-site-switcher-wrap" style="position:relative">
        ...
        <div class="db-site-dropdown" id="db-site-dropdown" hidden
            ...
            <button type="button"
                    ...
                    style="display:block;width:100%;padding:10px 16px;border:0;background:{{ $site->id === ($activeSite ?? null)?->id ? '#e8f3ed' : 'transparent' }};text-align:left;cursor:pointer;font:inherit;font-size:14px;color:#17231f">
                {{ $site->name }}
            </button>
            @endforeach
        </div>
