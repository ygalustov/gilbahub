> **ВАРИАНТ ОТВЕРГНУТ. ПО ЭТОМУ ПЛАНУ НЕ ЧИНИТЬ.**
> Это «вариант 2 — минимальная починка без смены архитектуры». Владелец выбрала другой путь.
> **Дефект GH-439 закрыт по плану `PLAN-GH439-site-config-db-only-RU.md`** — он же самый
> цитируемый документ папки, восемь упоминаний в changelog.
> Пометка поставлена 19.09.2026: файл лежал непомеченным рядом с принятым планом, и нашедший его
> первым пошёл бы чинить по отвергнутому варианту. Файл сохранён как след решения, а не как
> руководство.
