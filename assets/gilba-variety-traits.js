 ...
 *   Superstar GL (GLS, cold tolerant), SR 4650 (highest GLS resistance), SR 4660ST (salt tolerant)
          ...
          traits: {
            ...
            ,
                helminthosporium: {
                  riskMultiplier: 1.05,
                  confidence: 'low',
                  source: 'No direct helminthosporium data for TifTuf; elevated risk assumed for warm-season susceptible improved bermuda',
                },
              }
          },
          ...
          traits: {
            ...
            ,
                helminthosporium: {
                  riskMultiplier: 0.95,
                  confidence: 'low',
                  source: 'No direct helminthosporium data for TifTuf cold zone; moderate risk assumed',
                },
              }
          },
          ...
          traits: {
            ...
            ,
                helminthosporium: {
                  riskMultiplier: 0.95,
                  confidence: 'low',
                  source: 'No direct helminthosporium trial data for Wintergreen; bred for Victorian conditions, moderate risk assumed',
                },
              }
          },
          ...
          traits: {
            ...
            disease: { springDeadSpot: { riskMultiplier: 0.85, confidence: 'medium', source: 'Cold tolerance heritage' } ,
                dollarSpot: {
                  riskMultiplier: 1.00,
                  confidence: 'low',
                  source: 'No direct dollar spot data for Wintergreen; couch average assumed',
                },
                largePatch: {
                  riskMultiplier: 1.00,
                  confidence: 'low',
                  source: 'No direct large patch data for Wintergreen; couch average assumed',
                },
                helminthosporium: {
                  riskMultiplier: 0.95,
                  confidence: 'low',
          ...
          ,
            disease: {
                springDeadSpot: {
                  riskMultiplier: 1.05,
                  confidence: 'medium',
                  source: 'Wintergreen cold tolerance average in STRI trial; SDS risk elevated in frost-prone zones',
                notes: 'Higher SDS risk in cold climates',
                },
                dollarSpot: {
                  riskMultiplier: 1.00,
                  confidence: 'low',
          ...
          traits: {
            ...
            ,
                helminthosporium: {
                  riskMultiplier: 1.05,
                  confidence: 'low',
                  source: 'No direct helminthosporium data for OZ TUFF; dense canopy and warm-season susceptibility elevate risk',
                },
              }
          },
          ...
          traits: {
            disease: {
                springDeadSpot: {
                  riskMultiplier: 1.05,
                  confidence: 'low',
                  source: 'OZ TUFF not tested in cold climates; SDS risk extrapolated from wear density correlation',
                },
                dollarSpot: {
                  riskMultiplier: 1.00,
                  confidence: 'low',
                  source: 'No direct dollar spot data for OZ TUFF; couch average assumed',
                },
                largePatch: {
                  riskMultiplier: 1.05,
                  confidence: 'low',
                  source: 'No direct large patch data for OZ TUFF; dense sward may elevate humidity and disease risk',
                },
                helminthosporium: {
                  riskMultiplier: 1.05,
                  confidence: 'low',
          ...
          traits: {
            ...
            ,
                helminthosporium: {
                  riskMultiplier: 0.95,
                  confidence: 'low',
                  source: 'No direct helminthosporium data for Legend; moderate risk assumed from limited disease trial data',
                },
              }
          },
          ...
          traits: {
            ...
            ,
                helminthosporium: {
                  riskMultiplier: 0.90,
                  confidence: 'low',
                  source: 'No direct helminthosporium data for Grand Prix; #1 cold tolerance (TU08007) correlates with lower cool-season disease risk',
                },
              }
          },
          ...
          traits: {
            ...
            ,
                helminthosporium: {
                  riskMultiplier: 0.90,
                  confidence: 'low',
                  source: 'No direct helminthosporium data for Santa Ana; #1 QSAC + #2 cold tolerance (TU08007) - well-adapted varieties carry lower disease susceptibility',
                },
              }
          },
          ...
          traits: {
            ...
            ,
                helminthosporium: {
                  riskMultiplier: 0.95,
                  confidence: 'low',
                  source: 'No direct helminthosporium data for Windsor Green; cold-climate specialist, moderate risk assumed',
                },
              }
          },
          ...
          traits: {
            disease: {
                springDeadSpot: {
                  riskMultiplier: 1.00,
                  confidence: 'low',
                  source: 'Windsor Green not tested in subtropical/temperate; SDS risk average for untested zones',
                },
                dollarSpot: {
                  riskMultiplier: 1.00,
                  confidence: 'low',
                  source: 'No direct dollar spot data for Windsor Green in subtropical/temperate; couch average assumed',
                },
                largePatch: {
                  riskMultiplier: 1.00,
                  confidence: 'low',
                  source: 'No direct large patch data for Windsor Green; couch average assumed',
                },
                helminthosporium: {
                  riskMultiplier: 0.95,
                  confidence: 'low',
          ...
          traits: {
            ...
            ,
                helminthosporium: {
                  riskMultiplier: 0.95,
                  confidence: 'low',
                  source: 'No direct helminthosporium data for Conquest; cold-only trial variety, moderate risk assumed',
                },
              }
          },
          ...
          traits: {
            disease: {
                springDeadSpot: {
                  riskMultiplier: 1.00,
                  confidence: 'low',
                  source: 'Conquest not tested in subtropical/temperate; SDS risk average for untested zones',
                },
                dollarSpot: {
                  riskMultiplier: 1.00,
                  confidence: 'low',
                  source: 'No direct dollar spot data for Conquest; couch average assumed',
                },
                largePatch: {
                  riskMultiplier: 1.00,
                  confidence: 'low',
                  source: 'No direct large patch data for Conquest; couch average assumed',
                },
                helminthosporium: {
                  riskMultiplier: 0.95,
                  confidence: 'low',
          ...
          traits: {
            ...
            ,
                helminthosporium: {
                  riskMultiplier: 1.00,
                  confidence: 'low',
                  source: 'No direct helminthosporium data for AgriDark; C. dactylon x transvaalensis hybrid, moderate risk assumed',
                },
              }
          },
          ...
          traits: {
            disease: {
                springDeadSpot: {
                  riskMultiplier: 1.05,
                  confidence: 'low',
                  source: 'AgriDark not tested in Australian cold climates; SDS risk moderately elevated for uncharacterised zones',
                },
                dollarSpot: {
                  riskMultiplier: 1.00,
                  confidence: 'low',
                  source: 'No direct dollar spot data for AgriDark in temperate/cold; couch average assumed',
                },
                largePatch: {
                  riskMultiplier: 1.00,
                  confidence: 'low',
                  source: 'No direct large patch data for AgriDark; couch average assumed',
                },
                helminthosporium: {
                  riskMultiplier: 1.00,
                  confidence: 'low',
          ...
          traits: {
            disease: {
                ...
                helminthosporium: {
                  riskMultiplier: 0.95,
                  confidence: 'low',
                  source: 'No direct helminthosporium data for AgriDark cold zone; reduced risk assumed at lower temperatures',
                },
            }
          }
        }
          ...
          traits: {
            ...
            ,
                dollarSpot: {
                  riskMultiplier: 1.00,
                  confidence: 'low',
                  source: 'No direct dollar spot data for Rio; couch average assumed',
                },
                largePatch: {
                  riskMultiplier: 1.00,
                  confidence: 'low',
                  source: 'No direct large patch data for Rio; couch average assumed',
                },
                helminthosporium: {
                  riskMultiplier: 1.05,
                  confidence: 'low',
                  source: 'No direct helminthosporium data for Rio; seeded bermuda warm-season susceptibility - moderate-high risk assumed',
                },
              }
          },
          ...
          ,
            disease: {
                springDeadSpot: {
                  riskMultiplier: 1.05,
                  confidence: 'low',
                  source: 'Rio SDS risk elevated in temperate/cold zones; NTEP cold climate correlation',
                },
                dollarSpot: {
                  riskMultiplier: 1.00,
                  confidence: 'low',
                ...
                helminthosporium: {
                  riskMultiplier: 1.00,
                  confidence: 'low',
                  source: 'No direct helminthosporium data for Rio cold zone; couch average risk assumed',
                },
            }
          },
      ...
      traits: {
        ...
        disease: {
          springDeadSpot: {
            riskMultiplier: 1.00,
            confidence: 'low',
            source: 'No NTEP disease trial data for Monaco; seeded bermuda average assumed',
            notes: 'Insufficient disease data for Monaco',
          },
          dollarSpot: {
            riskMultiplier: 1.00,
            confidence: 'low',
            source: 'No direct dollar spot data for Monaco; seeded bermuda average',
          },
          largePatch: {
            riskMultiplier: 1.00,
            confidence: 'low',
            source: 'No large patch data for Monaco; couch average assumed',
          },
          helminthosporium: {
            riskMultiplier: 1.00,
            confidence: 'low',
            source: 'No helminthosporium trial data for Monaco; seeded bermuda average',
          },
        }
      }
    },
      ...
      traits: {
        ...
        ,
                springDeadSpot: {
                  riskMultiplier: 1.00,
                  confidence: 'low',
                  source: 'No NTEP disease trial data for Maya (RAD-CD1); seeded bermuda average assumed',
                notes: 'Insufficient disease data',
                },
                largePatch: {
                  riskMultiplier: 1.00,
                  confidence: 'low',
                  source: 'No large patch data for Maya; couch average assumed',
                },
                helminthosporium: {
                  riskMultiplier: 1.00,
                  confidence: 'low',
                  source: 'No helminthosporium trial data for Maya; seeded bermuda average',
                },
              },
    ...
    '007': {
      ...
      regionalTraits: {
        ...
        cold_ntep: {
          ...
          ,
            cold: {
              winterHardiness: 1.05,
              springGreenupDays: -3,
              winterkillRisk: 0.9,
              confidence: 'medium',
              source: 'NTEP 2003-2008 Purdue IN + Penn State PA: Above-average winter survival; early spring greenup noted',
              notes: 'Selected for heat AND cold performance; solid cold hardiness for improved bentgrass',
            },
          },
        ...
        cold_ntep: {
          ...
          ,
            cold: {
              ...
              winterkillRisk: 1.0,
              confidence: 'low',
              source: 'NTEP 2003-2008: Sister variety to 007; cold performance assumed similar to species mean',
              notes: 'Heat specialist - cold data limited; species average assumed',
            },
          },
    ...
    'Pure Distinction': {
      ...
      regionalTraits: {
        ...
        cold_ntep: {
          ...
          ,
            cold: {
              winterHardiness: 1.08,
              springGreenupDays: -4,
              winterkillRisk: 0.85,
              confidence: 'medium',
              source: 'NTEP 2003-2008 Purdue IN: High winter survival ratings; spring greenup among earliest across cold locations',
              notes: 'Consistently strong cold climate performer across NTEP',
            },
          },
    ...
    'Macdonald': {
      ...
      ,
        cold: {
          ...
          winterkillRisk: 0.85,
          confidence: 'medium',
          source: 'DLF Super Bents A-LIST certification + NZSTI trial data: superior cold hardiness documented; pinkSnowMould resistance correlates with cold adaptation',
          notes: 'NZ-bred variety; cold performance well above species average per DLF breeding program documentation',
        },
      }
    },
    ...
    'Declaration': {
      ...
      regionalTraits: {
        ...
        cold_ntep: {
          ...
          ,
            cold: {
              winterHardiness: 1.03,
              springGreenupDays: -2,
              winterkillRisk: 0.92,
              confidence: 'medium',
              source: 'NTEP 2003-2008 Purdue IN: Good winter survival; spring greenup slightly early',
              notes: 'All-rounder with reasonable cold performance across NTEP cold locations',
            },
          },
    ...
    'Penn A-1': {
      ...
      regionalTraits: {
        ...
        cold_ntep: {
          ...
          ,
            cold: {
              winterHardiness: 0.95,
              springGreenupDays: 2,
              winterkillRisk: 1.1,
              confidence: 'medium',
              source: 'NTEP 2003-2008: Below-average winter survival at coldest NTEP locations; late spring greenup at Purdue IN',
              notes: 'Heat-adapted variety; not well suited to Canberra/Southern Highlands cold winters',
            },
          },
        ...
        cold_ntep: {
          ...
          ,
            cold: {
              ...
              winterkillRisk: 1.08,
              confidence: 'medium',
              source: 'NTEP 2003-2008: Moderate cold hardiness; similar to Penn A-1 warm-season profile',
              notes: 'Better suited to subtropical/temperate than cold climates',
            },
          },
        ...
        cold_ntep: {
          ...
          ,
            cold: {
              ...
              winterkillRisk: 1.0,
              confidence: 'high',
              source: 'NTEP benchmark variety 2003-2008 and historical: Standard cold hardiness reference for creeping bentgrass across all US cold locations',
              notes: 'Historical benchmark; cold performance thoroughly characterised across 60+ years NTEP data',
            },
          },
    ...
    'Piper': {
      ...
      regionalTraits: {
        ...
        cold_ntep: {
          ...
          ,
            cold: {
              winterHardiness: 0.98,
              springGreenupDays: 1,
              winterkillRisk: 1.05,
              confidence: 'low',
              source: 'NTEP 2003-2008: Near species-average cold performance; no outstanding cold hardiness trait noted in trial documentation',
              notes: 'Standard creeping bentgrass cold tolerance assumed',
            },
          },
    ...
    'Oakley': {
      ...
      regionalTraits: {
        ...
        cold_ntep: {
          ...
          ,
            cold: {
              winterHardiness: 1.02,
              springGreenupDays: -1,
              winterkillRisk: 0.97,
              confidence: 'low',
              source: 'NTEP 2003-2008: Moderate performer at cold locations; near-average cold hardiness with slight improvement over Penncross',
              notes: 'No specific cold hardiness claim; slightly above average inferred from trial standings',
            },
          },
        ...
        cold_ntep: {
          ...
          ,
            cold: {
              ...
              winterkillRisk: 0.9,
              confidence: 'medium',
              source: 'NTEP 2012-2017: Above-average winter survival; good spring greenup at cold locations',
              notes: 'NZ/AU marketed variety with above-average cold performance documentation',
            },
          },
        ...
        ,
          traits: {
            cold: {
              ...
              winterkillRisk: 0.85,
              confidence: 'medium',
              source: 'NTEP 2003-2008 Purdue IN + Penn State: Among best winter survival; very early spring greenup',
              notes: 'Cold climate specialist - well documented in NTEP and bentgrassdoctor.com',
            },
          }
        }
      }
      ...
      regionalTraits: {
        temperate_ntep: {
          ...
          traits: {
            ...
            disease: {
              // b35fix239: 0.85→0.70. Prior value was a generic NTEP backstop with no
              // specific trial data. Supporting evidence:
              // (1) DLF/Landscape Supply product specs: "high resistance to dollar spot,
              //     brown patch and Fusarium patch" — breeder claim, not peer-reviewed but
              //     consistent across multiple market descriptions.
              // (2) Glenelg Golf Club (SA) 2-year cultivar trial (published 2021): Mackenzie
              //     plot showed "little to no disease incidence" across trial period, comparable
              //     to the 007/Flagstick/SR1150 blend which has NTEP-confirmed 0.75 multiplier.
              // (3) Hempfling et al. 2021 (Crop Science): Smith-Kerns over-predicts on
              //     tolerant cultivars — field absence of disease with high model outputs is
              //     consistent with Mackenzie being in the tolerant group.
              // Confidence medium: no peer-reviewed AU cultivar disease trial data exists.
              dollarSpot: { riskMultiplier: 0.70, confidence: 'medium', source: 'DLF Super Bents specs (high resistance); Glenelg GC SA 2-year trial 2021 (little to no disease incidence); Hempfling et al. 2021 Crop Sci' },
        ...
        ,
          traits: {
            cold: {
              ...
              winterkillRisk: 0.9,
              confidence: 'low',
              source: 'NTEP 2003-2008: Good winter performance; above-average cold hardiness inferred from consistent cold-location performance',
              notes: 'Cold-tolerant variety per commercial documentation; DLF cold climate breeding',
            },
          }
        }
      }
    ...
    'Penn A-4': {
      ...
      regionalTraits: {
        ...
        cold_ntep: {
          ...
          ,
            cold: {
              winterHardiness: 0.97,
              springGreenupDays: 1,
              winterkillRisk: 1.05,
              confidence: 'medium',
              source: 'NTEP 2003-2008: Moderate cold hardiness; Penn series warm-season adaptation bias; slightly below species average at coldest locations',
              notes: 'Slightly below average cold hardiness for creeping bentgrass',
            },
          },
        ...
        temperate_ntep: {
          ...
          traits: {
            ...
            disease: {
              ...
              // L-93 is consistently rated in the resistant/moderate-resistant group:
              // - Abernathy et al. 2001 (Crop Science): L-93 rated MOST RESISTANT of 5 cultivars
              //   tested at College Station TX (Crenshaw most susceptible)
              // - Penn State NTEP 2008-2013: L-93 "intermediate tolerance" — among top performers
              //   in earlier trials; newer cultivars (Declaration, Proclamation) now superior
              // - Koch et al. 2009 (multi-state): consistently in resistant group
              // 0.82 reflects moderate resistance, below neutral (1.0) but acknowledging that
        ...
        ,
          traits: {
            cold: {
              ...
              winterkillRisk: 0.95,
              confidence: 'medium',
              source: 'NTEP 2012-2017 Purdue IN: Good overall performance including cold climate locations; consistent winter survival',
              notes: 'All-round performer with solid cold hardiness across NTEP',
            },
          }
        }
      }
      ...
      traits: {
        ...
        disease: {
          ...
          crownRust: {
            riskMultiplier: 0.85,
            confidence: 'medium',
            source: 'DLF breeding program - modern endophyte-enhanced varieties',
            notes: 'Good crown rust resistance typical of newer DLF lines'
          },
          brownPatch: {
            riskMultiplier: 1.00,
            confidence: 'medium',
      ...
      traits: {
        ...
        disease: {
          grayLeafSpot: {
            riskMultiplier: 0.92,
            confidence: 'low',
            source: 'Breeder specifications - DLF Seeds - still Category I recommended VA/MD 2024',
            notes: 'GLS pressure minimal in NZ/AU temperate climate; estimate based on breeding lineage'
          },
          crownRust: {
            riskMultiplier: 0.95,
            confidence: 'low',
            source: 'Breeder specifications - DLF Seeds - still Category I recommended VA/MD 2024',
            notes: 'Crown rust estimate based on typical NZ-bred PRG performance'
          }
        }
      }
    },
      ...
      traits: {
        ...
        disease: {
          grayLeafSpot: {
            riskMultiplier: 0.92,
            confidence: 'low',
            source: 'Breeder specifications - PGG Wrightson Turf Continental-type PRG',
            notes: 'GLS pressure minimal in NZ/AU temperate climate; estimate based on breeding lineage'
          },
          crownRust: {
            riskMultiplier: 0.9,
      ...
      traits: {
        ...
        disease: {
          grayLeafSpot: {
            riskMultiplier: 0.9,
            confidence: 'low',
            source: 'Breeder specifications - Village Green Seeds premier NZ sports turf variety',
            notes: 'GLS pressure minimal in NZ/AU temperate climate; estimate based on breeding lineage'
          },
          crownRust: {
            riskMultiplier: 0.88,
      ...
      traits: {
        ...
        disease: {
          grayLeafSpot: {
            riskMultiplier: 0.88,
            confidence: 'low',
            source: 'Breeder specifications - Barenbrug - bred for NZ winter sports fields',
            notes: 'GLS pressure minimal in NZ/AU temperate climate; estimate based on breeding lineage'
          },
          crownRust: {
            riskMultiplier: 0.85,
      ...
      traits: {
        ...
        disease: {
          grayLeafSpot: {
            riskMultiplier: 0.90,
            confidence: 'medium',
            source: 'DLF 4turf specifications - tetraploid vigor enhances disease tolerance',
            notes: 'Improved GLS tolerance through tetraploid genetic vigor'
          },
          crownRust: {
            riskMultiplier: 0.88,
            confidence: 'medium',
            source: 'DLF 4turf specifications - enhanced disease resistance',
            notes: 'Good crown rust resistance from tetraploid breeding'
          },
          fusarium: {
            riskMultiplier: 0.80,
            confidence: 'medium',
      ...
      traits: {
        ...
        disease: {
          ...
          crownRust: {
            ...
            notes: 'Adequate crown rust resistance'
          },
          brownPatch: {
            riskMultiplier: 0.95,
            confidence: 'medium',
      ...
      traits: {
        ...
        disease: {
          ...
          crownRust: {
            ...
            confidence: 'medium',
            source: 'NTEP disease trials',
            notes: 'Average crown rust susceptibility'
          },
          brownPatch: {
            riskMultiplier: 1.00,
            confidence: 'medium',
      ...
      traits: {
        ...
        disease: {
          ...
          crownRust: {
            riskMultiplier: 0.92,
            confidence: 'medium',
            source: 'Barenbrug disease ratings',
            notes: 'Good crown rust resistance'
          }
        },
      ...
      traits: {
        ...
        disease: {
          ...
          crownRust: {
            riskMultiplier: 0.82,
            confidence: 'high',
            source: 'NTEP 2005-2011 crown rust trials',
            notes: 'Good crown rust resistance'
          },
          brownPatch: {
            riskMultiplier: 0.95,
      ...
      traits: {
        ...
        disease: {
          grayLeafSpot: {
            riskMultiplier: 0.92,
            confidence: 'low',
            source: 'PGG Wrightson Turf specifications - NZ-bred variety',
            notes: 'Moderate GLS tolerance - NZ climate has limited GLS pressure'
          },
          crownRust: {
            riskMultiplier: 0.90,
            confidence: 'low',
      ...
      traits: {
        ...
        disease: {
          grayLeafSpot: {
            riskMultiplier: 0.92,
            confidence: 'low',
            source: 'PGG Wrightson Turf specifications - Mediterranean genetics',
            notes: 'Moderate GLS tolerance - primary data from NZ/Mediterranean conditions'
          },
          crownRust: {
            riskMultiplier: 0.90,
            confidence: 'low',
      ...
      traits: {
        disease: {
          ...
          crownRust: {
            ...
            confidence: 'high',
            source: 'NTEP 2016-2021 crown rust trials',
            notes: 'Excellent crown rust resistance'
          },
          brownPatch: {
            riskMultiplier: 0.90,
            confidence: 'medium',
      ...
      traits: {
        ...
        disease: {
          grayLeafSpot: {
            riskMultiplier: 1.0,
            confidence: 'low',
            source: 'Breeder specifications - AU market variety',
            notes: 'Placeholder - update with AU trial results'
          },
          crownRust: {
            riskMultiplier: 1.0,
      ...
      traits: {
        ...
        disease: {
          ...
          anthracnose: {
            riskMultiplier: 0.95,
            confidence: 'low',
            source: 'Cool-season NZ/AU conditions limit anthracnose; near-species average assumed',
          },
        },
    ...
    'Manor': {
      ...
      traits: {
        ...
        disease: {
          ...
          anthracnose: {
            riskMultiplier: 0.95,
            confidence: 'low',
            source: 'Cool NZ/AU conditions limit anthracnose; near-average assumed',
          },
        },
      ...
      ,
        cold: {
          ...
          winterkillRisk: 0.92,
          confidence: 'medium',
          source: 'PGG Wrightson/DLF specifications: good cold hardiness documented; BSPB 2025 good overall performance',
          notes: 'Solid cold performer; suits temperate AU and NZ lowland sites',
        },
      }
    },
    ...
    'Egmont': {
      ...
      ,
        cold: {
          ...
          winterkillRisk: 0.88,
          confidence: 'medium',
          source: 'BSPB 2025: slowest regrowth (6.7/9) consistent with deeper dormancy and better cold adaptation; Grasslands NZ breeding = highland selection',
          notes: 'Rumball & Robinson 1982 NZ J Exp Ag: NZ-bred variety with good cold adaptation; slow regrowth suits low-input cold-climate management',
        },
      }
    },
    ...
    'Barking': {
      ...
      traits: {
        ...
        disease: {
          ...
          anthracnose: {
            riskMultiplier: 1.00,
            confidence: 'low',
            source: 'Cool NZ/AU conditions limit anthracnose; near-average assumed for shade specialist',
          },
        },
      ...
      ,
        cold: {
          ...
          winterkillRisk: 1.05,
          confidence: 'low',
          source: 'BSPB 2025: UK origin shade specialist; no specific cold claim; slightly below browntop average cold hardiness inferred from temperate maritime breeding context',
          notes: 'Less cold-adapted than NZ-bred varieties (Arrowtown, Egmont); suits temperate maritime rather than highland cold sites',
        },
      }
    }
  },
      ...
      ,
        disease: {
          largePatch: {
            riskMultiplier: 1.15,
            confidence: 'low',
            source: 'No peer-reviewed trial data; Kenda 4x rhizome density implies dense canopy and elevated moisture retention - large patch risk above species average',
            notes: 'Rhizoctonia solani AG2-2 primary kikuyu disease in AU subtropical/temperate',
          },
          dollarSpot: {
            riskMultiplier: 0.9,
            confidence: 'low',
            source: 'Kikuyu generally tolerant of dollar spot; no Kenda-specific data - species-level tolerance assumed',
          },
          helminthosporium: {
            riskMultiplier: 0.95,
            confidence: 'low',
            source: 'No helminthosporium trial data for Kenda; kikuyu species average assumed',
          },
        }
      }
    },
      ...
      ,
        disease: {
          largePatch: {
            riskMultiplier: 1.05,
            confidence: 'low',
            source: 'No peer-reviewed trial data; Village Green moderate growth habit suggests near-average large patch susceptibility for kikuyu',
            notes: 'Rhizoctonia solani AG2-2 primary kikuyu disease in AU',
          },
          dollarSpot: {
            riskMultiplier: 0.9,
            confidence: 'low',
            source: 'Kikuyu generally tolerant of dollar spot; no Village Green-specific data',
          },
          helminthosporium: {
            riskMultiplier: 0.95,
            confidence: 'low',
            source: 'No helminthosporium trial data for Village Green; kikuyu species average assumed',
          },
        }
      }
    },
      ...
      ,
        disease: {
          largePatch: {
            riskMultiplier: 0.95,
            confidence: 'low',
            source: 'No peer-reviewed trial data; Whittet open growth habit (Grafton 1960, seeded) implies marginally better airflow than rhizome-dense varieties',
            notes: 'Rhizoctonia solani AG2-2 primary kikuyu disease in AU',
          },
          dollarSpot: {
            riskMultiplier: 0.9,
            confidence: 'low',
            source: 'Kikuyu generally tolerant of dollar spot; no Whittet-specific data',
          },
          helminthosporium: {
            riskMultiplier: 0.95,
            confidence: 'low',
            source: 'No helminthosporium trial data for Whittet; kikuyu species average assumed',
          },
        }
      }
    }
 ...
 * SpeciesController uses 'couch' as canonical, but VARIETY_TRAITS uses 'couch' (canonical)
 * This mapping bridges the two systems
 */
const SPECIES_TO_TRAITS_KEY = {
  'couch': 'couch',              // SpeciesController canonical = VARIETY_TRAITS key
 ...
 *          "Couch" -> "couch" (direct canonical match)
...
function normalizeSpeciesKey(species) {
  ...
  // Species aliases - maps to VARIETY_TRAITS keys (uses 'couch' (canonical))
  const aliases = {
    'couch': 'couch',
    'couch/bermuda': 'couch', 
    'couchbermuda': 'couch',
 ...
 * @param {string} species - e.g., 'couch', 'bentgrass', 'perennialRyegrass'
...
function getDiseaseModifier(species, variety, disease) {
  // b35fix239: Cross-region fallback — when a variety has no disease data in its
  // own regional blocks, try other regional trait files before falling back to the
  // species-level multiplier (which represents worst-case susceptibility, not average).
  // Priority chain for dollar spot (and other diseases):
  //   1. Variety's own regionalTraits (all zones, existing behaviour)
  //   2. UK/BSPB file (gaip_getUKDiseaseModifier) — climate-transferable for bentgrass/ryegrass
  //   3. Return 1.0 (neutral, not species-amplified) with confidence 'none'
  // Rationale: falling back to 1.0 + species susceptibility (e.g. bent 1.3, PRG 0.95)
  // is correct. The old behaviour of returning 1.0 when there IS data in another
  // regional file means a UK Mackenzie green ignores the AU Mackenzie 0.85 entry.
  ...
  const varietyData = speciesData[variety];
  if (!varietyData) {
    // b35fix239: Before returning 1.0, try UK file as cross-region source.
    // This covers varieties present in UK file but not in GAIP_VARIETY_TRAITS
    // (e.g. BSPB-only cultivars used on AU/NZ courses).
    if (typeof window !== 'undefined' && typeof window.gaip_getUKDiseaseModifier === 'function') {
      const ukResult = window.gaip_getUKDiseaseModifier(species, variety, disease);
      if (ukResult && ukResult.confidence !== 'none' && ukResult.riskMultiplier !== undefined) {
        return {
          ...ukResult,
          _crossRegion: true,
          _crossRegionSource: 'uk-variety-traits',
        };
      }
    }
  ...
  // Check regionalTraits structure (current format)
  if (varietyData.regionalTraits) {
    // Priority: named AU/NTEP zones first, then couch zone keys (temperate, cold, ntep_us)
    const regionOrder = ['temperate_ntep', 'temperate_au', 'cold_ntep', 'subtropical', 'subtropical_au',
                         'temperate', 'cold', 'ntep_us', 'nzsti_nz', 'nzsti_auckland', 'bspb_uk'];
    for (const region of regionOrder) {
      const regionData = varietyData.regionalTraits[region];
    ...
    // b35fix239: Variety exists in GAIP_VARIETY_TRAITS but has no disease entry for
    // this disease in ANY zone. Try UK file before falling back to 1.0.
    if (typeof window !== 'undefined' && typeof window.gaip_getUKDiseaseModifier === 'function') {
      const ukResult = window.gaip_getUKDiseaseModifier(species, variety, disease);
      if (ukResult && ukResult.confidence !== 'none' && ukResult.riskMultiplier !== undefined) {
        return {
...
function getAustralianCouchVarieties() {
  ...
  Object.keys(VARIETY_TRAITS.couch || {}).forEach(name => {
    if (!name.startsWith('_')) {
      const v = VARIETY_TRAITS.couch[name];
      varieties.push({
        value: name,
...
if (typeof window !== 'undefined') {
  window.GAIP_VARIETY_TRAITS = VARIETY_TRAITS;
  ...
  window.gaip_getAustralianCouchVarieties = getAustralianCouchVarieties;
  window.gaip_getAustralianKikuyuVarieties = getAustralianKikuyuVarieties;
  window.gaip_getAustralianRyegrassVarieties = getAustralianRyegrassVarieties;
  window.gaip_getAustralianTallFescueVarieties = getAustralianTallFescueVarieties;
